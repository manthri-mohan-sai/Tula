...
/// Formats a fractional change (e.g. 0.32 → "32%", 2.5 → "2.5x") into a
/// compact, human-readable label. Percentages up to 100% read fine as-is;
/// above 100% we switch to a one-decimal multiplier ("2.5x" instead of
/// "250%") following Apple's Screen Time convention. Returns just the number
/// portion; callers add directional words ("above", "below") as needed.
