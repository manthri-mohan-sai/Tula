...
struct HomeView: View {
    ...
    private var upcomingRecurring: [(rule: RecurringRule, date: Date)] {
        ...
        return
            allRecurringRules
            // Zero-amount rules are skipped — prompting "₹0 · Did you
            // have this?" is noise, not a reminder.
            .filter { !$0.isPaused && $0.amount > 0 }
    ...
    private var overdueRecurring: [(rule: RecurringRule, date: Date)] {
        ...
        where !rule.isPaused && rule.kind == .expense && rule.amount > 0 {
