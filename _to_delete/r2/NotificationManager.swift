...
enum NotificationManager {
    ...
    /// Route marker carried in `userInfo` so a tap can open the catch-up
    ...
    /// Unlogged days in the recent window, for reminder copy.
    ///
    ...
    nonisolated static func cancelConfirmations(for ruleID: UUID) {
